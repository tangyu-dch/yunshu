...
export function PoolPhonePage() {
  ...
  const { data } = useQuery({ queryKey: ['operate', 'pool-phone', pageNumber, pageSize], queryFn: () => fetchPoolPhones(pageNumber, pageSize) })
  ...
  const toggleMutation = useMutation({
    ...
    onSuccess: async () => {
      ...
      await queryClient.invalidateQueries({ queryKey: ['operate', 'pool-phone'] })
    },
