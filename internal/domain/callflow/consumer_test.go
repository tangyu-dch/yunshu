...
func TestConsumersAdvanceAPIOutboundWorkflows(t *testing.T) {
	...
	RegisterConsumers(bus, ctiRunner, eslRunner, nil, nil, nil, nil, nil)
...
func TestAPIOutboundBridgesOnlyAfterCustomer183OrAnswer(t *testing.T) {
	...
	RegisterConsumers(bus, ctiRunner, eslRunner, session, originate, runtimeSelector, candidateSource, nil)
...
func TestBatchOutboundSymmetricFlow(t *testing.T) {
	...
	RegisterConsumers(bus, ctiRunner, eslRunner, session, originate, nil, nil, nil)
...
func TestCTIPostCallWorkflowTransitions(t *testing.T) {
	...
	RegisterConsumers(bus, ctiRunner, nil, nil, nil, nil, nil, nil)
