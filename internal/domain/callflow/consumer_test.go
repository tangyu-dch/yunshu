...
func TestConsumersAdvanceAPIOutboundWorkflows(t *testing.T) {
	...
	RegisterConsumers(context.Background(), bus, ctiRunner, eslRunner, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestAPIOutboundBridgesOnlyAfterCustomer183OrAnswer(t *testing.T) {
	...
	RegisterConsumers(context.Background(), bus, ctiRunner, eslRunner, session, originate, runtimeSelector, candidateSource, nil, nil, nil, nil, nil)
...
func TestBatchOutboundSymmetricFlow(t *testing.T) {
	...
	RegisterConsumers(context.Background(), bus, ctiRunner, eslRunner, session, originate, nil, nil, nil, nil, nil, nil, nil)
...
func TestCTIPostCallWorkflowTransitions(t *testing.T) {
	...
	RegisterConsumers(context.Background(), bus, ctiRunner, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
