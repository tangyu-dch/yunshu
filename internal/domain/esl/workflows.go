	...
	return []workflow.Definition{
		{
			...
			Transitions: []workflow.Transition{
				...
				{From: "command_received", On: "CHANNEL_HANGUP_COMPLETE", To: "complete"},
				{From: "validated", On: "execute_originate", To: "originating"},
				{From: "validated", On: "CHANNEL_HANGUP_COMPLETE", To: "complete"},
				{From: "originating", On: "CHANNEL_CREATE", To: "created"},
				{From: "originating", On: "CHANNEL_HANGUP_COMPLETE", To: "complete"},
		...
		},
		{
			...
			Transitions: []workflow.Transition{
				...
				{From: "init", On: "CHANNEL_HANGUP_COMPLETE", To: "complete"},
				...
				{From: "agent_created", On: "validate_command", To: "customer_validated"},
				{From: "agent_progress", On: "validate_command", To: "customer_validated"},
				{From: "agent_progress_media", On: "validate_command", To: "customer_validated"},
				...
				{From: "customer_validated", On: "CHANNEL_HANGUP_COMPLETE", To: "complete"},
		...
		},
		{
			...
			Transitions: []workflow.Transition{
				...
				{From: "agent_validated", On: "CHANNEL_HANGUP_COMPLETE", To: "complete"},
